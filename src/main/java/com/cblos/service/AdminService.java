...
import com.cblos.event.CustomerApprovedEvent;
...
public class AdminService {
    ...
    @Autowired
    private SalesforceCustomerSyncService salesforceCustomerSyncService;
    ...
    public AppUser reviewCustomerRegistration(Integer customerId, boolean approve, String reason) {
        ...
        if (approve) {
            ...
            customerRepository.save(customer);
            AppUser savedUser = userRepository.save(userCredential);
            eventPublisher.publishEvent(new CustomerApprovedEvent(customerId));
            return savedUser;
        }
